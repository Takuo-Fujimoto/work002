...
import TextInputEffectsCSS from './TextInputEffects.css';
...
class JuroInput extends Component {
    ...
    render() {
        ...
        let adjustMargin = (this.props.col -1) * 14;
        let outerWidthCss = 'calc(' + (this.props.col * 30) + '% - 0.5em + '+ adjustMargin +'px )';
        return (
            <span className={containerClassName} style={{ width: outerWidthCss }}>
                {inputComponent}
